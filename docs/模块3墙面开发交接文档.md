...
> **历史文档提示（2026-08-05）：** 本文记录的是墙面开发开始前的设计状态，其中“墙面和线路仍为 Dummy 页面”等描述已经过时。新的窗口请先阅读当前总交接：`/Users/flacko/Documents/Codex/SummerIntern/poc/docs/POC当前状态与后续开发交接文档.md`。当前源代码与 Prisma Schema 的优先级高于本文。
